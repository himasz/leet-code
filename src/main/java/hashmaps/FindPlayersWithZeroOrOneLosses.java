...
public class FindPlayersWithZeroOrOneLosses {
    ...
    public List<List<Integer>> findWinners(int[][] matches) {
        ...
        results.add(zeroLoss);
        results.add(oneLoss);
        return results;
    }

    public static void main(String[] args) {
        FindPlayersWithZeroOrOneLosses sol = new FindPlayersWithZeroOrOneLosses();

        int[][] a = {{1, 3}, {2, 3}, {3, 6}, {5, 6}, {5, 7}, {4, 5}, {4, 8}, {4, 9}, {10, 4}, {10, 9}};
        System.out.println(Arrays.deepToString(a));
        System.out.println(sol.findWinners(a));

        int[][] b = {{2, 3}, {1, 3}, {5, 4}, {6, 4}};
        System.out.println(Arrays.deepToString(b));
        System.out.println(sol.findWinners(b));
        ...
        System.out.println("---------------");
        System.out.println(sol.findWinners(c));
